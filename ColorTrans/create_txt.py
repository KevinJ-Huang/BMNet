...
if __name__ == '__main__':
    ...
    parser.add_argument('--mask', type=str, default='/home/jieh/Projects/Shadow/Dataset/Dataset1/test/mask', metavar='PATH', help='root dir to save high resolution images')
